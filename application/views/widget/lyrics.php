...
<p>
	<a target="_blank" href="http://widget.renren.com/dialog/forward?url=<?php echo urlencode(site_url('widget/lyrics')); ?>&title=<?php echo urlencode('我的歌词帖'); ?>&images=<?php echo urlencode(base_url("upload/lyrics/{$user->id}.png")); ?>">
...
<!-- 	<a target="_blank" href="http://widget.renren.com/dialog/share?resourceUrl=<?php echo urlencode(site_url('widget/lyrics')); ?>&pic=<?php echo urlencode(base_url("{$user->id}.png")); ?>&title=<?php echo urlencode('我的歌词帖'); ?>&description=<?php echo urlencode($lyrics); ?>&images=<?php echo urlencode(base_url("{$user->id}.png")); ?>&charset=UTF-8">
	...
	<a target="_blank" href="http://service.weibo.com/share/share.php?url=<?php echo urlencode(site_url('widget/lyrics')); ?>&title=<?php echo urlencode('毕业纪念册の我的歌词帖：' . $lyrics); ?>&pic=<?php echo urlencode(base_url("upload/lyrics/{$user->id}.png")); ?>">
