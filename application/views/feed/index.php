...
<ul class="comment">
	...
	<li>
		...
		<div class="meta">
			<a href="<?php echo site_url('home/view/' . $c->from_user); ?>" class="bubble">From: <?php echo R::load('user', $c->from_user)->name; ?></a>
			<a href="<?php echo site_url('home/view/' . $c->to_user); ?>" class="bubble">To: <?php echo R::load('user', $c->to_user)->name; ?></a>
