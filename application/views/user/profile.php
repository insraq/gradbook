<div class="row">
	...
	<?php echo form_open('user/profile/edit', array('class' => 'form-horizontal')); ?>
		<fieldset>
			<legend>基本信息</legend>
			...
			<div class="control-group">
				<label class="control-label" for="faculty">学系</label>
				<div class="controls">
					<select name="faculty" class="span4">
			...
			<div class="control-group">
				<label class="control-label" for="faculty">OCamp 大组</label>
				<div class="controls">
					<select name="faculty" class="span2">
			...
			<div class="control-group">
				<label class="control-label" for="faculty">OCamp 小组</label>
				<div class="controls">
					<select name="faculty" class="span2">
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="relationship" class="span2">
						...
						<option value="恋爱中">出国工作</option>
						<option value="说不准">说不准</option>
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="mobile" value="<?php echo $user->mobile; ?>" class="input-xlarge">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="qq" value="<?php echo $user->mobile; ?>" class="input-xlarge">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="msn">MSN</label>
				<div class="controls">
					<input type="text" name="msn" value="<?php echo $user->mobile; ?>" class="input-xlarge">
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<select name="aim" class="span2">
						<option value="留港工作">留港工作</option>
						<option value="出国工作">出国工作</option>
						<option value="内地工作">内地工作</option>
						<option value="留港读书">留港读书</option>
						<option value="出国读书">内地读书</option>
						<option value="内地读书">内地读书</option>
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="input-xlarge" name="moment" rows="3"></textarea>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="comment1" class="input-xlarge">？
					<input type="text" name="comment2" class="input-xlarge">！
